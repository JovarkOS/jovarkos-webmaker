...
function getEmail() {
    ...
    if (email_regex.test(email)) {
        const data = {
            // Effectively autoincrement the id by adding 1 to the cell above it
        ...
        fetch("https://sheet.best/api/sheets/f02e1734-3fa0-4dc1-84ab-72a0e6f99f03", {
            ...
            .then((data) => {
                ...
                console.log(data);
                // Render confetti on submission success
                var confirmationText = document.getElementById('confirmation-text');
                confirmationText.innerText = "Thank you for subscribing!";
            })
            .catch((error) => {
